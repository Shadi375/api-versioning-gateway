...
public class PathMatcher {
    ...
    final Map<String, PathMatcher.AntPathStringMatcher> stringMatcherCache = new ConcurrentHashMap<String, PathMatcher.AntPathStringMatcher>(256);
    ...
    public PathMatcher() {
        ...
        this.pathSeparatorPatternCache = new PathMatcher.PathSeparatorPatternCache(DEFAULT_PATH_SEPARATOR);
    }
    ...
    public PathMatcher(String pathSeparator) {
        ...
        this.pathSeparatorPatternCache = new PathMatcher.PathSeparatorPatternCache(pathSeparator);
    }
    ...
    public void setPathSeparator(String pathSeparator) {
        ...
        this.pathSeparatorPatternCache = new PathMatcher.PathSeparatorPatternCache(this.pathSeparator);
    }
    ...
    /**
     * Build or retrieve an {@link PathMatcher.AntPathStringMatcher} for the given pattern.
     * <p>The default implementation checks this PathMatcher's internal cache
